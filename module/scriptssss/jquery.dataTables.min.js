...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Afisez _MENU_ inregistrari",sZeroRecords:"Nu exista inregistrari care sa corespunda criteriului de cautare",sEmptyTable:"No data available in table",
sLoadingRecords:"Loading...",sInfo:"Afisare de la _START_ la _END_ din _TOTAL_ inregistrari",sInfoEmpty:"Afisare 0 la 0 din 0 inregistrari",sInfoFiltered:"(filtrate din _MAX_ inregistrari)",sInfoPostFix:"",sSearch:"Filtreaza:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",bRegex:false,
